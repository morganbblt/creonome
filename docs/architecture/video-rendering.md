...
The Vertex path was verified end to end in production on 2026-08-02 with an authenticated 8-second, 720×1280 MP4 generated by `veo-3.1-fast-generate-001`, persisted in the private media bucket and played through the tenant-scoped API stream.
