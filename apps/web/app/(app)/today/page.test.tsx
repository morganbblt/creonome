...
describe("Today page", () => {
  ...
  it("discloses when a live batch was itself generated by the backend's local fallback", async () => {
    getCurrentOpportunities.mockResolvedValue({ ...batch, fallback: true });
    render(await TodayPage());

    expect(screen.getByRole("status").textContent).toMatch(
      /mvp demo.*local fallback/i,
    );
    expect(screen.queryAllByRole("article")).toHaveLength(3);
  });
