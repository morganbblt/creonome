export const demoProjects = [
  {
    ...
    detail: "Warehouse Tapes · edited 40 min ago",
    level: "Ready",
    score: 86,
    tone: "ready",
  },
  {
    title: "Silent studio: a beat with zero voice",
    detail: "Warehouse Tapes · 2 pending changes",
    level: "Script",
    score: 81,
    tone: "script",
  },
  {
    title: "Silent studio · saved 9 days ago",
    detail: "momentum cooled · re-angle or archive",
    level: "Idea",
    score: null,
    tone: "cooled",
  },
  {
    title: "Track recipe: four ingredients",
    detail: "Unsorted · saved 1 Aug",
    level: "Idea",
    score: 74,
    tone: "idea",
  },
...
export const demoLibraryItems = [
  { name: "warehouse_01.mov", detail: "0:41 · rush", kind: "video" },
  { name: "desk_topdown.mov", detail: "1:12 · rush", kind: "video" },
  { name: "needle_macro.mov", detail: "0:22 · rush", kind: "video" },
  { name: "tape_loop_A.wav", detail: "0:32 · stem", kind: "audio" },
  { name: "crate_find_v3.mp4", detail: "0:28 · 41 MB", kind: "export" },
] as const;
